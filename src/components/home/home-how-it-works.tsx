...
export function HomeHowItWorks() {
  ...
  return (
    <section id="cara-kerja" className="scroll-mt-24 px-5 py-20 sm:px-8 lg:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <div ref={ref} className="relative mt-14">
          ...
          <ol className="grid gap-8 md:grid-cols-2 md:gap-10 lg:grid-cols-4 lg:gap-6">
            {workflowSteps.map((step, index) => (
              ...
              >
                ...
                <div className="pt-1 lg:pr-4">
                  ...
                  <p className="mt-3 text-[11px] uppercase tracking-[0.14em] text-accent/80">
                    {step.detail}
                  </p>
                </div>
              </Reveal>
