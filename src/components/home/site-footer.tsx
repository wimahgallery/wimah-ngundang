...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-border bg-surface/40 px-5 py-14 sm:px-8">
      <div className="mx-auto grid max-w-6xl gap-10 sm:grid-cols-2 md:gap-12 lg:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          <div className="flex items-center gap-2.5">
            <Image src="/wimah.png" alt="" width={30} height={30} className="invert" />
          ...
          <ul className="mt-4 space-y-2.5">
            {navigationLinks.map((item) => (
              <li key={item.href}>
                <a
                  href={item.href}
                  className="text-xs text-text-secondary transition-colors duration-300 hover:text-accent"
                >
                  {item.label}
                </a>
              </li>
          ...
          <ul className="mt-4 space-y-2.5">
            <li>
              <a
                ...
                className="inline-flex items-center gap-2 text-xs text-text-secondary transition-colors duration-300 hover:text-accent"
              >
      ...
      <div className="mx-auto mt-10 flex max-w-6xl flex-col items-center justify-between gap-3 border-t border-border pt-6 text-[11px] text-text-secondary sm:flex-row">
        <p>
